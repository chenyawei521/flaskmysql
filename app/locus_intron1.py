...
gene_nm_exons = msgpack.unpackb(msgpack.packb(open(filepath).read()))
hgmdNMs = msgpack.unpackb(msgpack.packb(open(hgmdNMs_path).read()))
# gene_nm_exons = msgpack.unpackb(msgpack.packb(open(filepath).read()))
# hgmdNMs = msgpack.unpackb(msgpack.packb(open(hgmdNMs_path).read()))
# # print gene_nm_exons
hgmdNMs = set(hgmdNMs)
...
print intron_snp_locus("VPS13A","79896846","T","C")
